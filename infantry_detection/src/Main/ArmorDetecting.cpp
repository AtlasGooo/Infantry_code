...
void armorDetecting(Mat src, Mat camera_intrinsics, Mat camera_distortion, Color enemy_color)
{
    VideoCapture cap("../videos/mono_armor_detect.avi");
    //Set armor detector prop
    detector.loadSVM("/home/babyxin/dev/JLURoboVision/General/123svm.xml");

    //Set angle solver prop
    // angleSolver.setCameraParam("/home/babyxin/dev/JLURoboVision/General/camera_params.xml", 1);
    ...
    do
    {
        ...
        if(detector.isFoundArmor())
        {
            ...
            // printf("Detect armor sizes: %d\n", (int)detector.armors.size());
        }
        ...
        //     Mat armorImg;
        //     if (!detector.classifier.warpPerspective_src.empty())
        //     {
        //         // cv::cvtColor( detector.classifier.warpPerspective_src, armorImg, COLOR_BGR2GRAY );
        //         // cv::equalizeHist(detector.classifier.warpPerspective_src,armorImg);            
        //         imshow("armorsrc",detector.classifier.warpPerspective_src);
        //         imshow("armordst",detector.classifier.warpPerspective_dst);
        //     }
        // }
        ...
        //					   1  2  3  4  5  6  7
        detector.showDebugInfo(0, 0, 0, 1, 0, 1, 0);
